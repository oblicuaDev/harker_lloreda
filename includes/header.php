      ...
      <div class="right">
        ...
        <ul class="agendamenu">
          <li>
            ...
            <ul>
              <li><a href="https://dermocitas.sicme.co/H4RLl0882" target="_blank"><?=$sdk->palabras[$lang][22]?></a></li>
              <li><a href="<?=$sdk->infoGnrl->acf->link_soy_paciente_nuevo?>" target="_blank"><?=$sdk->palabras[$lang][23]?></a></li>
            </ul>
          </li>
        </ul>
      </div>
  ...
  <div class="container">
    ...
    <nav>
      ...
      <ul>
        ...
        <li><a href="<?=$lang?>/linea-de-prevencion"><?= $sdk->palabras[$lang][6]?></a></li>
